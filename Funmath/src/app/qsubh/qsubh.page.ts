...
@Component({
  selector: 'app-qsubh',
  templateUrl: './qsubh.page.html',
  styleUrls: ['./qsubh.page.scss'],
})
export class QsubhPage implements OnInit {
  ...
  constructor( ) { 
    ...
    while( this.Num1<this.Num2 ){
      ...
      this.Num1= Math.floor(Math.random() * 9 + 25);
      this.Num2 = Math.floor(Math.random() * 7 + 15 );

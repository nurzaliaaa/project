...
@Component({
  selector: 'app-qaddm',
  templateUrl: './qaddm.page.html',
  styleUrls: ['./qaddm.page.scss'],
})
export class QaddmPage implements OnInit {
  ...
  constructor( ) { 
    ...
    while( this.Num1<this.Num2 ){
        ...
        this.Num1= Math.floor(Math.random() * 6 + 9);
        this.Num2= Math.floor(Math.random() * 3 + 8);
